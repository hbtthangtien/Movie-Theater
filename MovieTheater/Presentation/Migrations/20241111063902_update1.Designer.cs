...
namespace WebAPI.Migrations
{
    ...
    [Migration("20241111063902_update1")]
            ...
            modelBuilder.Entity("WebAPI.Entity.Ticket", b =>
                {
                    ...
                    b.Property<string>("cinema_room_name")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("movie_name")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateOnly?>("schedule_show")
                        .HasColumnType("date");

                    b.Property<string>("schedule_show_time")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WebAPI.Entity.Ticket", b =>
                {
                    ...
                    b.HasOne("WebAPI.Entity.ScheduleSeat", null)
                        .WithMany("Tickets")
